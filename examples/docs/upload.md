...
<template>
    <div class="global-anchor">
      <znv-anchor :scroll-offset="100">
        ...
        <znv-anchor-link href="#duo-xuan" title="多选"></znv-anchor-link>
        <znv-anchor-link href="#shou-dong-shang-chuan" title="手动上传"></znv-anchor-link>
        <znv-anchor-link href="#tuo-zhuai-shang-chuan" title="拖拽上传"></znv-anchor-link>
...
<div style="width: 400px;">
  <znv-upload action="//jsonplaceholder.typicode.com/posts/">
     <znv-button icon="ios-cloud-upload" plain type="primary"> 点击上传</znv-button>
  </znv-upload>
</div>
</template>
```
...
<template>
<div style="width: 400px;">
  <znv-upload action="//jsonplaceholder.typicode.com/posts/" multiple>
     <znv-button icon="ios-cloud-upload" plain type="primary"> 点击上传</znv-button>
  </znv-upload>
</div>
</template>
...
<template>
<div style="width: 400px;">
  <znv-upload action="//jsonplaceholder.typicode.com/posts/" :before-upload="handleUpload">
  </znv-upload>
  <div v-if="file !== null">Upload file: {{ file.name }} 
      <znv-button type="text" @click="upload" :loading="loadingStatus">
  ...
  <znv-upload action="//jsonplaceholder.typicode.com/posts/"
    ...
    <div style="padding: 20px 0;border:1px dashed #eee;cursor: pointer;" 
      flex="dir:top main:center cross:center">
        <p><znv-icon name="ios-cloud-upload" size="52" style="color: #3399ff"></znv-icon></p>
