...
<template>
    <div class="global-anchor">
      <znv-anchor :scroll-offset="100">
        ...
        <znv-anchor-link href="#qia-pian-mo-shi" title="卡片模式"></znv-anchor-link>
        <znv-anchor-link href="#zeng-jia-he-yi-chu" title="增加和移除"></znv-anchor-link>
        <znv-anchor-link href="#contextmenu" title="ContextMenu右键菜单"></znv-anchor-link>
        <znv-anchor-link href="#biao-qian-mo-shi" title="标签模式"></znv-anchor-link>
...
```html
<template>
  <znv-tabs v-model="activeTab" :data="tabs"></znv-tabs>
...
```html
<template>
  <znv-tabs v-model="activeTab" :data="tabs" type="card"></znv-tabs>
  <p v-show="activeTab==='tab1'">用户管理</p>
  <p v-show="activeTab==='tab2'">组织管理</p>
  <p v-show="activeTab==='tab3'">系统管理</p>
  <p v-show="activeTab==='tab4'">目录模块配置</p>
...
```html
<template>
  <div class="mb-15"><znv-button type="primary" plain size="small" @click="handleAdd">add tab</znv-button></div>
  <znv-tabs v-model="activeTab" :data="tabs" type="card" closable
    @on-tab-close="handleTabClose"></znv-tabs>
...
```html
<template>
  <znv-tabs v-model="activeTab" :data="tabs" type="card" closable context-menu
...
<template>
  <div class="mb-15"><znv-button type="primary" plain size="small" @click="handleAdd">add tab</znv-button></div>
  <znv-tabs v-model="activeTab" :data="tabs" type="tag" closable context-menu
    ref="tabs" @on-tab-close="handleTabClose" @on-tab-select="handleSelect">
    <template v-slot:menu>
        <li @click="refreshSelected">刷新</li>
        <li @click="closeSelected">关闭</li>
