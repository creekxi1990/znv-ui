...
util.title = function (title) {
  window.document.title = title || 'znv-ui'
}
...
util.open = function (url, target = false) {
  ...
  a.setAttribute('id', 'znv-link-temp')
  document.body.appendChild(a)
  a.click()
  document.body.removeChild(document.getElementById('znv-link-temp'))
}
...
util.copy = function (content) {
  return new Promise(resolve => {
    ...
    copyInput.setAttribute('id', 'znv-copy-temp')
    document.body.appendChild(copyInput)
    copyInput.select() // 选择对象
    let result = document.execCommand('Copy') // 执行浏览器复制命令
    copyInput.style.display = 'none'
    document.body.removeChild(document.getElementById('znv-copy-temp'))
    resolve(result)
  })
}
