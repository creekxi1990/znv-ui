      ...
      <div :class="[prefixCls + '-content', prefixCls + '-content-left']" v-show="!isTime">
        <div :class="[datePrefixCls + '-header']" v-show="currentView !== 'time'">
            <span
              ...
              @click="prevYear('left')"><znv-icon name="ios-arrow-back"></znv-icon></span>
          <span
            v-if="leftPickerTable === 'date-table'"
            :class="iconBtnCls('prev')"
            @click="prevMonth('left')"
            v-show="currentView === 'date'"><znv-icon name="ios-arrow-back"></znv-icon></span>
          <date-panel-label
          ...
          <span
            ...
            @click="nextYear('left')"><znv-icon name="ios-arrow-forward"></znv-icon></span>
          <span
            v-if="splitPanels && leftPickerTable === 'date-table'"
            :class="iconBtnCls('next')"
            @click="nextMonth('left')"
            v-show="currentView === 'date'"><znv-icon name="ios-arrow-forward"></znv-icon></span>
        </div>
        <component
          :is="leftPickerTable"
          ref="leftYearTable"
      ...
      <div :class="[prefixCls + '-content', prefixCls + '-content-right']" v-show="!isTime">
        <div :class="[datePrefixCls + '-header']" v-show="currentView !== 'time'">
                    <span
                      ...
                      :class="iconBtnCls('prev', '-double')"
                      @click="prevYear('right')"><znv-icon name="ios-arrow-back"></znv-icon></span>
          <span
            v-if="splitPanels && rightPickerTable === 'date-table'"
            :class="iconBtnCls('prev')"
          ...
          <span
            :class="iconBtnCls('next', '-double')"
            @click="nextYear('right')"><znv-icon name="ios-arrow-forward"></znv-icon></span>
          <span
...
<script>
  import ZnvIcon from '../../../icon/icon.vue'
  ...
  const prefixCls = 'znv-picker-panel'
  const datePrefixCls = 'znv-date-picker'
  ...
  export default {
    ...
    components: { ZnvIcon, DateTable, YearTable, MonthTable, TimePicker, Confirm, datePanelLabel },
    props: {
