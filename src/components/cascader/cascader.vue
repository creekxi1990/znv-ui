    ...
    <div :class="[prefixCls + '-rel']" @click="toggleOpen" ref="reference">
      ...
      <slot>
        <znv-input
            ...
            :size="size"
            :placeholder="inputPlaceholder"></znv-input>
        <div :class="[prefixCls + '-label']" v-show="filterable && query === ''" @click="handleFocus">
          {{ displayRender }}
        </div>
        <znv-icon name="ios-close-circle" :class="[prefixCls + '-arrow']" v-show="showCloseIcon"
                @click.native.stop="clearSelect"></znv-icon>
        <znv-icon name="ios-arrow-down" :class="[prefixCls + '-arrow']"></znv-icon>
      </slot>
    </div>
...
<script>
  ...
  const prefixCls = 'znv-cascader'
  const selectPrefixCls = 'znv-select'
