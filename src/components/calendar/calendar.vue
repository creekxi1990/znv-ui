<template>
  <div class="znv-calendar" :class="{'card':mini}">
    <div class="znv-calendar-header">
      <template v-if="mini">
        <span>{{headerTitle}}</span>
        <znv-button-group>
          <znv-button size="mini" @click="handlePrevMonth" icon="doubleleft"></znv-button>
          <znv-button size="mini" @click="handleToday">今天</znv-button>
          <znv-button size="mini" @click="handleNextMonth" icon="doubleright"></znv-button>
        </znv-button-group>
      </template>
      <template v-else>
        <div class="znv-calendar-header-title">
          {{headerTitle}}
        </div>
        <znv-button-group>
          <znv-button size="mini" @click="handlePrevMonth">上个月</znv-button>
          <znv-button size="mini" @click="handleToday">今天</znv-button>
          <znv-button size="mini" @click="handleNextMonth">下个月</znv-button>
        </znv-button-group>
      </template>
    </div>
    <ul class="znv-calendar-week">
      <li v-for="(item, index) in calendarTitleArr" :key="index" class="znv-calendar-week-item">{{item}}</li>
    </ul>
    <ul class="znv-calendar-body" :style="bodyStyle">
      <li v-for="(item, index) in visibleCalendar" :key="index"
          class="znv-calendar-date-view" :style="dateViewStyle"
