<template>
  <div :style="{ cursor, userSelect}" class="znv-splitter-container clear-fix" @mouseup="onMouseUp"
       @mousemove="onMouseMove">

    <pane class="znv-splitter-pane splitter-left" :split="split" :style="{ [type]: percent+'%'}">
      <slot name="left"></slot>
    </pane>
    ...
    <pane class="znv-splitter-pane splitter-right" :split="split" :style="{ [type]: 100-percent+'%'}">
