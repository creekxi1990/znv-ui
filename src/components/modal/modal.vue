<template>
  <div class="znv-modal">
    <transition name="fade-in-linear">
      <div class="znv-modal-mask" :style="wrapStyles" v-show="visible" v-if="showMask" @click.stop="handleMask"></div>
    </transition>
        ...
        <div :class="classes" :style="mainStyles" v-show="visible">
          <div :class="contentClasses" ref="content" :style="contentStyles" @click="handleClickModal">
            ...
            <div :class="[prefixCls + '-footer']" v-if="!footerHide">
              <slot name="footer">
                <znv-button @click="cancel">{{ cancelText }}</znv-button>
                <znv-button type="primary" :loading="buttonLoading" @click="ok">{{ okText }}</znv-button>
              </slot>
            </div>
          </div>
        </div>
      ...
      visible(val) {
        if (val === false) {
          ...
          this.timer = setTimeout(() => {
            ...
            if (
              (!hasClass(this.$parent.$el, 'znv-modal') && !this.stopRemoveScroll) ||
