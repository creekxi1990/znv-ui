      ...
      <transition :name="'move-' + placement">
        <div :class="classes" :style="mainStyles" v-show="visible">
          <div :class="contentClasses" ref="content">
            <a class="znv-drawer-close" v-if="closable" @click="close">
              <slot name="close">
                <znv-icon name="close"></znv-icon>
              </slot>
            </a>
          ...
          <div class="znv-drawer-drag" :class="{ 'znv-drawer-drag-left': placement === 'left' }" v-if="draggable"
               @mousedown="handleTriggerMousedown">
            <slot name="trigger">
              <div class="znv-drawer-drag-move-trigger">
                <div class="znv-drawer-drag-move-trigger-point">
                  <i></i><i></i><i></i><i></i><i></i>
                </div>
              </div>
            </slot>
  ...
  export default {
    ...
    methods: {
      ...
      handleWrapClick(event) {
        // use indexOf,do not use === ,because znv-modal-wrap can have other custom className
      ...
      visible(val) {
        if (val === false) {
          this.timer = setTimeout(() => {
            ...
            const brotherDrawers = findBrothersComponents(this, 'ZnvDrawer') || []
            const parentDrawers = findComponentsUpward(this, 'ZnvDrawer') || []
        ...
        this.broadcast('ZnvTable', 'on-visible-change', val)
